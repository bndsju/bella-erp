...
public class PedidoItem {
    ...
    private PedidoItem(UUID id, UUID produtoId, BigDecimal quantidade, BigDecimal valorUnitario) {
        this.id = id;
    ...
    public static PedidoItem novo(UUID produtoId, BigDecimal quantidade, BigDecimal valorUnitario) {
        return new PedidoItem(UUID.randomUUID(), produtoId, quantidade, valorUnitario);
    }

    public static PedidoItem existente(UUID id, UUID produtoId, BigDecimal quantidade, BigDecimal valorUnitario) {
        return new PedidoItem(id, produtoId, quantidade, valorUnitario);
    }
